...
Our open-source projects include:
  ...
  - [Agents at Scale Ark](https://github.com/mckinsey/agents-at-scale-ark) - A declarative, Kubernetes-native framework for building portable, scalable, and provider-agnostic agentic applications. It helps teams define, deploy, and operate distributed AI agents using Kubernetes-native patterns.
  ...
  - [QuantumBlack Design System](https://github.com/mckinsey/quantumblack-design-system) - A shadcn-based component registry for the QuantumBlack Design System, providing reusable React components, documentation, installation guides, and live demos.
